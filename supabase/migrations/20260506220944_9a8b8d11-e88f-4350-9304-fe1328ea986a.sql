-- ==========================================
-- 1. RESET COMPLETO (CRÍTICO)
-- ==========================================
-- Removendo em ordem de dependência para evitar erros de constraint
...
-- Garantir que um time jogue apenas uma vez por rodada
...
-- ==========================================
-- 3. LÓGICA DE GERAÇÃO (ROBIN CIRCLE)
-- ==========================================
...
ALTER TABLE public.beginner_cup ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.beginner_cup_participants ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "Public Read" ON public.beginner_cup FOR SELECT USING (true);
CREATE POLICY "Public Read" ON public.beginner_cup_participants FOR SELECT USING (true);
