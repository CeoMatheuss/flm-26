          ...
          try {
            ...
            if (clubRef) {
              await supabase.from('world_players').insert([{
                ...
                market_value: promotedPlayer.marketValue || 0,
                salary: promotedPlayer.salary || 500,
                attributes: promotedPlayer.attributes as any,
                nationality: promotedPlayer.nationality || 'Brasil',
