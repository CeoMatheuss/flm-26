...
const updates: Update[] = [
  {
    ...
    type: 'feature',
    items: [
      '🏟️ Nome do estádio do mandante aparece no Painel e na aba Jogos',
      '⚽ Amistosos contra BOT agora geram torcida (escala reduzida — 30% do normal)',
      '📈 Ganho de torcida em amistosos limitado por partida (max +300) para evitar farm',
      '🏗️ Base/Academia agora exige nível mínimo 1 para gerar jogadores',
      '💡 Mensagem de boas-vindas melhorada no sino com dicas de primeiros passos',
      '📊 Tabela da liga mostra apenas premiação da divisão atual (Série A/B/C/D)',
      '🏆 Premiação Continental removida temporariamente (será adicionada quando criada)',
      '💰 Saldo online removido do cabeçalho da liga',
    ],
  },
  {
    version: '2.0.0',
    ...
    type: 'feature',
    items: [
      '🏗️ Sistema de Base completo com 30 níveis (Inicial → Mundial)',
      '💰 3 tiers de investimento na base: Básico (R$500k), Médio (R$1.5M), Alto (R$3M)',
      '👶 Qualidade dos jovens determinada pelo nível da base, não pelo dinheiro',
      '⭐ Chance de craque geracional nos níveis 26-30',
      '📊 Tabela de classificação da liga reformulada com todas as colunas (PTS, J, V, E, D, GP, GC, SG)',
      '🟢🔵🔴 Zonas visuais: Título, Continental e Rebaixamento na tabela',
      '📈 Últimos 5 jogos (forma) na tabela de classificação',
      '🏆 Premiações por divisão (Série A até D) com valores escalonados',
      '🔄 Critérios de ordenação: Pontos → Saldo → Gols → Derrotas',
    ],
  },
  {
    version: '1.9.0',
