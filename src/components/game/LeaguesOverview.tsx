...
import { leaguesByCountry, countryNames, countryFlags, countryLeagueNames, LeagueTeam } from '@/types/league';
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm flex items-center gap-2">
              ...
              {countryNames[selectedCountry]} — {teams.length} clubes
            </CardTitle>
          </CardHeader>
