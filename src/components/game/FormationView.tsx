                   ...
                   {player && (
                    ...
                    >
                     <div className="flex flex-col items-center -space-y-1">
                       <span className={`text-base sm:text-xl lg:text-2xl font-black tracking-tighter drop-shadow-md ${posTextColors[slot.position] || 'text-white'}`}>
                         {player ? getDynamicOverall(player, slot.position as Player['position']) : ''}
                       </span>
                       <span className={`text-[7px] sm:text-[9px] lg:text-[10px] font-bold uppercase opacity-80 ${posTextColors[slot.position] || 'text-white'}`}>
                         {slot.position}
                       </span>
                     </div>
