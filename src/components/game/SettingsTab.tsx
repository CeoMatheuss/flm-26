    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <p className="text-[10px] text-muted-foreground">Escolha o visual do jogo. O tema é salvo automaticamente.</p>
        </CardHeader>
        <CardContent className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="rounded-lg overflow-hidden mb-2.5 border border-border/50">
                <div className="bg-[hsl(220,30%,8%)] p-2 space-y-1.5">
                  ...
                  <div className="flex gap-1">
                    <div className="h-4 flex-1 rounded bg-[hsl(220,28%,12%)] border border-[hsl(220,25%,18%)]" />
                    <div className="h-4 flex-1 rounded bg-[hsl(220,28%,12%)] border border-[hsl(220,25%,18%)]" />
                  </div>
                </div>
              </div>
              ...
              <p className="text-[9px] text-muted-foreground mt-0.5">Navy blue elegante</p>
              {theme === 'dark' && (
            ...
            >
              ...
              <div className="rounded-lg overflow-hidden mb-2.5 border border-border/50">
                <div className="bg-[hsl(210,60%,94%)] p-2 space-y-1.5">
                  ...
                  <div className="flex gap-1">
                    <div className="h-4 flex-1 rounded bg-[hsl(200,50%,96%)] border border-[hsl(200,40%,85%)]" />
                    <div className="h-4 flex-1 rounded bg-[hsl(200,50%,96%)] border border-[hsl(200,40%,85%)]" />
                  </div>
                </div>
              </div>
              ...
              <p className="text-[9px] text-muted-foreground mt-0.5">Azul moderno e clean</p>
              {theme === 'light' && (
                <div className="absolute top-2 right-2 w-4 h-4 rounded-full bg-primary flex items-center justify-center">
                  <span className="text-[8px] text-primary-foreground font-bold">✓</span>
                </div>
          ...
          <p className="text-[9px] text-muted-foreground text-center">
            Tema atual: <span className="font-semibold text-foreground">{theme === 'dark' ? '🌙 Escuro' : '☀️ Claro'}</span>
          </p>
        </CardContent>
      </Card>
    </div>
