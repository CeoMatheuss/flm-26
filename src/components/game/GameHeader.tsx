...
import { Users, Star, Trophy, LogOut, ShoppingBag, ShoppingCart } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto px-3 sm:px-4 py-2 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <Button 
            ...
            variant="ghost" 
            onClick={() => {
              const tabEvent = new CustomEvent('flm:change-tab', { detail: 'shop' });
              window.dispatchEvent(tabEvent);
            }} 
            className="h-8 w-8 p-0 text-emerald-400 hover:text-emerald-500 hover:bg-emerald-500/10"
          >
