...
const typeConfig = {
  danger: {
    ...
    label: 'Urgente',
    labelClass: 'bg-destructive/15 text-destructive border-destructive/20',
    dot: 'bg-destructive',
  },
  warning: {
    ...
    label: 'Atenção',
    labelClass: 'bg-amber-400/15 text-amber-400 border-amber-400/20',
    dot: 'bg-amber-400',
  },
  info: {
    ...
    label: 'Info',
    labelClass: 'bg-blue-400/15 text-blue-400 border-blue-400/20',
    dot: 'bg-blue-400',
  },
  success: {
    ...
    label: 'Sucesso',
    labelClass: 'bg-emerald-400/15 text-emerald-400 border-emerald-400/20',
    dot: 'bg-emerald-400',
  },
};
