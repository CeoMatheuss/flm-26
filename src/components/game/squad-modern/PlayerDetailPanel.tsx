      ...
      <div className="h-full flex flex-col bg-transparent text-white selection:bg-emerald-500/30">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-8 custom-scrollbar">
          ...
          <section className="pb-10">
            ...
            <div className="grid grid-cols-2 gap-3">
              <ActionBtn icon={<ArrowRightLeft className="w-5 h-5" />} label="🔄 Substituir" onClick={() => { onClose(); onSwap?.(player); }} className="col-span-2 py-6 text-base bg-emerald-500 border-emerald-400 text-zinc-950 shadow-xl shadow-emerald-500/20 hover:scale-[1.02] hover:bg-emerald-400" />
              {isYouth && (
