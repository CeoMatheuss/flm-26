...
export function GameNavBar() {
  return (
    <div className="flex-1 flex items-center gap-1.5 overflow-hidden">
      {/* Aba Fixa: Itens essenciais que devem estar sempre visíveis */}
      <TabsList className="flex shrink-0 h-auto gap-0.5 bg-card/60 backdrop-blur-sm p-1 border border-border/20 rounded-xl">
        <TabsTrigger value="dashboard" className="nav-tab flex flex-col items-center gap-0.5 py-1.5 sm:py-2.5 min-w-[58px] sm:min-w-[65px] flex-1 basis-0">
          <LayoutDashboard className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
          <span className="text-[9px] sm:text-xs leading-tight font-medium">Início</span>
        </TabsTrigger>
        <TabsTrigger value="squad" className="nav-tab flex flex-col items-center gap-0.5 py-1.5 sm:py-2.5 min-w-[58px] sm:min-w-[65px] flex-1 basis-0">
          <Users className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
          <span className="text-[9px] sm:text-xs leading-tight font-medium">Elenco</span>
        </TabsTrigger>
        <TabsTrigger value="journal" className="nav-tab flex flex-col items-center gap-0.5 py-1.5 sm:py-2.5 min-w-[58px] sm:min-w-[65px] flex-1 basis-0">
          <Newspaper className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
          <span className="text-[9px] sm:text-xs leading-tight font-medium">Jornal</span>
        </TabsTrigger>
        <TabsTrigger value="tactics" className="nav-tab flex flex-col items-center gap-0.5 py-1.5 sm:py-2.5 min-w-[58px] sm:min-w-[65px] flex-1 basis-0">
          <Target className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
          <span className="text-[9px] sm:text-xs leading-tight font-medium">Táticas</span>
        </TabsTrigger>
        <TabsTrigger value="league" className="nav-tab flex flex-col items-center gap-0.5 py-1.5 sm:py-2.5 min-w-[58px] sm:min-w-[65px] flex-1 basis-0">
