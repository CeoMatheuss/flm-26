...
export function GameNavBar() {
  return (
    <TabsList className="flex-1 grid grid-cols-6 h-auto gap-0.5 bg-card/60 backdrop-blur-sm p-1 border border-border/20 rounded-xl">
      ...
      <TabsTrigger value="market" className="nav-tab flex flex-col items-center gap-0.5 py-2 sm:py-2.5"><ShoppingCart className="h-3.5 w-3.5 sm:h-4 sm:w-4" /><span className="text-[9px] sm:text-xs leading-tight font-medium">Mercado</span></TabsTrigger>
    </TabsList>
  );
}
