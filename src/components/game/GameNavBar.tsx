  ...
  return (
    <div className="flex-1 flex items-center gap-1.5 overflow-hidden">
      ...
      <TabsList className="flex shrink-0 h-auto gap-0.5 bg-card/60 backdrop-blur-sm p-1 border border-border/20 rounded-xl">
        <TabsTrigger value="dashboard" className="nav-tab flex flex-col items-center gap-0.5 py-1.5 sm:py-2.5 min-w-[65px] flex-1">
          <LayoutDashboard className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
          <span className="text-[9px] sm:text-xs leading-tight font-medium">Início</span>
        </TabsTrigger>
        <TabsTrigger value="squad" className="nav-tab flex flex-col items-center gap-0.5 py-1.5 sm:py-2.5 min-w-[65px] flex-1">
          <Users className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
          <span className="text-[9px] sm:text-xs leading-tight font-medium">Elenco</span>
        </TabsTrigger>
        <TabsTrigger value="journal" className="nav-tab flex flex-col items-center gap-0.5 py-1.5 sm:py-2.5 min-w-[65px] flex-1">
          <Newspaper className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
          <span className="text-[9px] sm:text-xs leading-tight font-medium">Jornal</span>
        </TabsTrigger>
        <TabsTrigger value="tactics" className="nav-tab flex flex-col items-center gap-0.5 py-1.5 sm:py-2.5 min-w-[65px] flex-1">
      ...
      <TabsList className="flex-1 flex overflow-x-auto h-auto gap-0.5 bg-card/60 backdrop-blur-sm p-1 border border-border/20 rounded-xl scrollbar-none no-scrollbar">
        <TabsTrigger value="league" className="nav-tab flex flex-col items-center gap-0.5 py-1.5 sm:py-2.5 min-w-[65px] flex-1">
