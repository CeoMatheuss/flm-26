  ...
  return (
    <div className="flex-1 flex flex-col gap-1">
      <TabsList className="grid grid-cols-6 h-auto gap-0.5 bg-card/60 backdrop-blur-sm p-1 border border-border/20 rounded-xl overflow-hidden">
        ...
        <TabsTrigger value="championships" className="nav-tab flex flex-col items-center gap-0.5 py-1.5 sm:py-2.5">
          <Globe className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-blue-400" />
          <span className="text-[9px] sm:text-xs leading-tight font-medium">Global</span>
        </TabsTrigger>
      </TabsList>
    </div>
  );
